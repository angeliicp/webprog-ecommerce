      ...
      <div class="mx-auto max-w-5xl">
        ...
        <nav class="flex py-3 text-gray-700" aria-label="Breadcrumb">
            ...
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Add Product</span>
                </div>
            </li>
            </ol>
        </nav>

        <h2 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-6">Add Product</h2>
        ...
        <form action="{{ route('adm-products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="prod_name" id="prod_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                </div>
                <div>
                    <label for="price" class="block mb-2 text-sm font-medium text-gray-900">Price</label>
                    <input type="number" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Put only the number (e.g. 1000)" required>
                </div>
                ...
                <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="text" name="top_notes" id="top_notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="mid_notes" class="block mb-2 text-sm font-medium text-gray-900">Mid Notes</label>
                        <input type="text" name="mid_notes" id="mid_notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="base_notes" class="block mb-2 text-sm font-medium text-gray-900">Base Notes</label>
                        <input type="text" name="base_notes" id="base_notes" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                </div>
                ...
                <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="age_group" id="age_group" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                    <div>
                        <label for="keyword" class="block mb-2 text-sm font-medium text-gray-900">Keyword</label>
                        <input type="text" name="keyword" id="keyword" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                    </div>
                </div>
                <div class="sm:col-span-2">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Description</label>
                    <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" required></textarea>
                </div>
            </div>
            <div>
                ...
                <input id="filename" name="filename" type="file" class="hidden" onchange="document.getElementById('filename-preview').textContent = this.files[0]?.name || ''">
            ...
            <div class="my-4">
                ...
                <textarea id="alt_desc" name="alt_desc" rows="2" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" required></textarea>
            </div>

            <div class="items-center space-y-4 sm:space-y-0 sm:space-x-4">
                <button type="submit" class="w-full sm:w-auto justify-center text-white inline-flex bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add product</button>
            </div>
        </form>
